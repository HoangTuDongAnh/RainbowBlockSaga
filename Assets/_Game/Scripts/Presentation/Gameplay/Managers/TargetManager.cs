            ...
            foreach (var target in _levelTargetInstance)
            {
                ...
                foreach (var bonusItem in bonusItems)
                {
                    if (bonusItem.Key == target.targetScriptable.bonusItem)
                    {
                        ...
                        {
                            //Debug.Log("bonus pool count: " + bonusAnimationPool.CountInactive);
                            var bonus = bonusAnimationPool.Get();
                            //Debug.Log("Animating bonus item towards target: " + target.targetScriptable.name);
                            //Debug.Log(target.targetScriptable.name);
