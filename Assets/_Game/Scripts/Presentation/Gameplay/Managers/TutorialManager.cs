...
namespace RainbowBlockSaga.Presentation.Scripts.Gameplay.Managers
{
    public class TutorialManager : MonoBehaviour
    {
        ...
        {
            // Board presentation uses nested canvases (ItemsCanvas / FXCanvas).
            // Keep tutorial guidance explicitly above gameplay presentation.
            var handCanvas = handSprite.GetComponent<Canvas>();
            if (handCanvas != null)
            {
                handCanvas.overrideSorting = true;
                handCanvas.sortingOrder = 10;
            }
