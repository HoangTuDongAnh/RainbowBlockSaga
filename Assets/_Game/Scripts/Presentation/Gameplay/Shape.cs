...
/*            if (initialTemplate == null)
                Debug.LogError("Không load được ItemTemplate_Hexagon từ Resources/Items/");
            else if (initialTemplate.customItemPrefab == null)
                Debug.LogError("ItemTemplate_Hexagon không có customItemPrefab!");
            else
            {
                Debug.Log("Đã load ItemTemplate_Hexagon thành công.");
            }*/
