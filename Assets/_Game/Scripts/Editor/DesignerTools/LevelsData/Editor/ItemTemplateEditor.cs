...
namespace RainbowBlockSaga.Presentation.Scripts.LevelsData.Editor
{
    ...
    public class ItemTemplateEditor : UnityEditor.Editor
    {
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            {
                var iconDrawer = new RainbowBlockSaga.Presentation.Scripts.Editor.Drawers.IconDrawer();
        ...
        private void CreateCustomPrefab(ItemTemplate itemTemplate)
        {
            ...
            string basePrefabPath = "Assets/_Game/Prefabs/Game/Item.prefab";
            ...
            // Create the prefab
            string prefabPath = "Assets/_Game/Resources/CustomItems";
