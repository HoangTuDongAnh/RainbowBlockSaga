...
using System.Linq;
using RainbowBlockSaga.Presentation.Scripts.Editor.Drawers;
...
namespace RainbowBlockSaga.Presentation.Scripts.LevelsData.Editor
{
    ...
    public class LevelEditor : UnityEditor.Editor
    {
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            // Load and apply USS
            var styleSheet = AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/_Game/UIBuilder/LevelEditorStyles.uss");
